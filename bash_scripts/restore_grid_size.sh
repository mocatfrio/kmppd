...
declare -a arr=("kmppd_a12ebb0a-2e55-4371-b99f-f85685e18717"
...
for i in "${arr[@]}"
do  
  sshpass -p $PASSWORD_SSH scp -r ~/database/site_$SITE_NUM/$i/ root@178.128.122.179:~/kmppd/system/database/site_$SITE_NUM/$i/ 
  if [ $? -eq 0 ];
  then
